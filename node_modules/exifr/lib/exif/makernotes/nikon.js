...
/* TODO do: 
// map custom settings additional to camInfos, see http://sno.phy.queensu.ca/~phil/exiftool/TagNames/NikonCustom.html
...
exports.extractMakernotes = function (data, makernoteOffset, tiffOffset) {
	...
	var tags = { 
		...
		*/
		...
		0x0e22: 
		 { desc: 'NEFBitDepth',
		   val: '{'\0 0 0 0\':'n/a (JPEG)',  \8 8 8 0\':'8 x 3',  \12 0 0 0\':'12',  \14 0 0 0\':'14',  \16 16 16 0\':'16 x 3'}' }
		   */
		0x0e22: 'NEFBitDepth'
	};
	
	var references = {
		MakerNoteVersion: function(data){
			//console.log( data );
			var v = parseFloat(data, 10)/100;
			return (typeof v === 'number') ? v : data;
		},
		ISO: function(data){
			//console.log( 'ISO' );
		...
		LensType: ['MF', 'D', 'G', 'VR'],
		ShootingMode: ['Continuous', 'Delay', 'PC Control', null, 'Exposure Bracketing', 'Auto ISO', 'White-Balance Bracketing', 'IR Control'],
		...
		MultiExposure: {0: 'Off', 1: 'Minimal', 2: 'Low', 3: 'Medium Low', 4: 'Normal', 5: 'Medium High', 6: 'High'},
		
		PreviewIFD: { 
			0x00fe: { desc: 'SubfileType',
				val: {0x0:'Full-resolution Image',  0x1:'Reduced-resolution image',  0x2:'Single page of multi-page image',  0x3:'Single page of multi-page reduced-resolution image',  0x4:'Transparency mask',  0x5:'Transparency mask of reduced-resolution image',  0x6:'Transparency mask of multi-page image',  0x7:'Transparency mask of reduced-resolution multi-page image',  0x10001:'Alternate reduced-resolution image',  0xffffffff:'invalid'
				/* TODO
				,  Bit 0:'Reduced resolution',  Bit 1:'Single page',  Bit 2:'Transparency mask',  Bit 3:'TIFF/IT final page',  Bit 4:'TIFF-FX mixed raster content'
				*/
				} 
			},
			...
			0x011a: 'XResolution',
			0x011b: 'YResolution',
			0x0128: { desc: 'ResolutionUnit', val: {1:'None',  2:'inches',  3:'cm'} },
			0x0201: 'PreviewImageStart',
			0x0202: 'PreviewImageLength',
			0x0213: { desc: 'YCbCrPositioning', val: {1:'Centered',  2:'Co-sited'} }
		},
		ColorBalanceA: 	{ 
			624: 'RedBalance', 
			625: 'BlueBalance' 
		...
		VRInfo: { 
			0: 'VRInfoVersion',
			4: { desc: 'VibrationReduction', val: {0:'n/a',  1:'On',  2:'Off'} },
			6: { desc: 'VRMode', val: {0:'Normal',  2:'Active'} } 
		},
		FaceDetect: { 
		...
		PictureControl: { 
			...
			48: { desc: 'PictureControlAdjust', val: {0:'Default Settings',  1:'Quick Adjust',  2:'Full Control'} },
		...
		WorldTime: { 
		  	0: 'Timezone',
			2: { desc: 'DaylightSavings', val: {0:'No',  1:'Yes'} },
			3: { desc: 'DateDisplayFormat', val: {0:'Y/M/D',  1:'M/D/Y',  2:'D/M/Y'} } 
		},
		/* TODO : FUNCTIONS ...
		ISOInfo: 
		  { 0: { desc: 'ISO', val: '{'(val:'100 * 2**(raw/12-5))'}' },
			6: { desc: 'ISO2', val: '{'(val:'100 * 2**(raw/12-5))'} },
			// 0x0 = Off\n  0x101 = Hi 0.3\n  0x102 = Hi 0.5\n  0x103 = Hi 0.7\n  0x104 = Hi 1.0\n  0x105 = Hi 1.3\n  0x106 = Hi 1.5: '' 
			},
			*/
		DistortInfo: { 
			0: 'DistortionVersion?',
			4: { desc: 'AutoDistortionControl', val: {0:'Off',  1:'On'} } 
		},
		UnknownInfo: { 0: 'UnknownInfoVersion?' },
		UnknownInfo2: { 0: 'UnknownInfo2Version?' },
		HDRInfo: { 
			0: 'HDRInfoVersion',
			4: { desc: 'HDR', val: {0:'Off',  1:'On',  48:'Auto'} },
			5: { desc: 'HDRLevel', val: {0:'Auto',  1:'1 EV',  2:'2 EV',  3:'3 EV',  255:'n/a'} },
			6: { desc: 'HDRSmoothing', val: {0: 'Off',  1: 'Normal', 2: 'Low', 3: 'High', 48: 'Auto', 255: 'n/a'} },
			7: { desc: 'HDRLevel2', val: {0:'Auto',  1:'1 EV',  2:'2 EV',  3:'3 EV',  255:'n/a'} }
		},
		LocationInfo: { 
			0: 'LocationInfoVersion',
			4: { desc: 'TextEncoding', val: {0:'n/a',  1:'UTF8',  2:'UTF16'} },
			5: 'CountryCode',
			9: 'Location' 
		},
		AFInfo: { 
			0: { desc: 'AFAreaMode', val: {0: 'Single Area', 1: 'Dynamic Area', 2: 'Dynamic Area (closest subject)', 3: 'Group Dynamic', 4: 'Single Area (wide)', 5: 'Dynamic Area (wide)'}},
			1: { desc: 'AFPoint', val: {0: 'Center', 1: 'Top', 2: 'Bottom', 3: 'Mid-left', 4: 'Mid-right', 5: 'Upper-left', 6: 'Upper-right', 7: 'Lower-left', 8: 'Lower-right', 9: 'Far Left', 10: 'Far Right'}},
			2: { desc: 'AFPointsInFocus',  val: ['Center', 'Top', 'Bottom', 'Mid-left', 'Upper-left', 'Lower-left', 'Far Left', 'Mid-right', 'Upper-right', 'Lower-right', 'Far Right'/* TODO ? 	0x7ff = All 11 Points (default) */] },
		},
		ShotInfo: { 
			0: 'ShotInfoVersion',
			4: 'FirmwareVersion',
			16: { desc: 'DistortionControl', val: {0:'Off',  1:'On'} },
			102:{ desc: 'VR_0x66?', val: {0:'Off',  1:'On (normal)',  2:'On (active)'} },
			106: 'ShutterCount',
			110: 'DeletedImageCount',
			117: { desc: 'VibrationReduction', val: {0:'Off',  1:'On (1)',  2:'On (2)',  3:'On (3)'} },
			130: { desc: 'VibrationReduction', val: {0:'Off',  1:'On'} },
			343: 'ShutterCount',
			430: { desc: 'VibrationReduction', val: {0x0:'n/a',  0xc:'Off',  0xf:'On'} },
			589: 'ShutterCount' 
		},
		...
		LensData01: { 
			...
			13: 'MinFocalLength',
			14: 'MaxFocalLength',
			15: 'MaxApertureAtMinFocal',
			16: 'MaxApertureAtMaxFocal',
			17: 'MCUVersion',
			18: 'EffectiveMaxAperture' 
		},
		LensData0204: { 
			0: 'LensDataVersion',
			4: 'ExitPupilPosition',
			...
			14: 'MinFocalLength',
			15: 'MaxFocalLength',
			16: 'MaxApertureAtMinFocal',
			17: 'MaxApertureAtMaxFocal',
			18: 'MCUVersion',
			19: 'EffectiveMaxAperture' 
		},
		LensData0400: { 0: 'LensDataVersion', 394: 'LensModel' },
		LensDataUnknown: { 0: 'LensDataVersion' },
		FlashInfo0100: { 
			0: 'FlashInfoVersion',
			4: { desc: 'FlashSource', val: {0:'None',  1:'External',  2:'Internal'} },
			6: { ref: 'FlashFirmware' },
			8: { desc: 'ExternalFlashFlags', val: ['Fired', null, 'Bounce Flash', null, 'Wide Flash Adapter', 'Dome Diffuser'] },
			10: 'FlashOutput/FlashCompensation',
			11: 'FlashFocalLength',
			12: 'RepeatingFlashRate',
			13: 'RepeatingFlashCount',
			14: { ref: 'FlashGNDistance' },
			15: { ref: 'FlashControlMode' },
			16: { ref: 'FlashControlMode' },
			17: 'FlashGroupAOutput/Compensation',
			18: 'FlashGroupBOutput/Compensation',
			9.1: { desc: 'FlashCommanderMode', val: {/*[Mask 0x80]*/  0x0:'Off',  0x80:'On'} },
		...
		*/
		...
		FlashInfo0102: { 
			...
			10: 'FlashOutput,  FlashCompensation',
			12: 'FlashFocalLength',
			13: 'RepeatingFlashRate',
			14: 'RepeatingFlashCount',
			15: { ref: 'FlashGNDistance' },
			18: 'FlashGroupAOutput,  FlashGroupACompensation',
			19: 'FlashGroupBOutput,  FlashGroupBCompensation',
			20: 'FlashGroupCOutput,  FlashGroupCCompensation',
			9.1: { desc: 'FlashCommanderMode', val: {/*[Mask 0x80]*/  0x0:'Off',  0x80:'On'} },
		...
		FlashInfo0103: { 
			...
			13: 'RepeatingFlashRate',
			14: 'RepeatingFlashCount',
			15: { ref: ' Nikon FlashGNDistance Values' },
			16:	{ desc: 'FlashColorFilter', val: {0: 'None', 1: 'FL-GL1', 2: 'FL-GL2', 9: 'TN-A1', 10: 'TN-A2', 65: 'Red', 66: 'Blue', 67: 'Yellow', 68: 'Amber'} },	  
			19: 'FlashGroupAOutput,  FlashGroupACompensation',
			20: 'FlashGroupBOutput,  FlashGroupBCompensation',
			21: 'FlashGroupCOutput,  FlashGroupCCompensation',
			27: 'ExternalFlashCompensation',
			29: 'FlashExposureComp3',
			39: 'FlashExposureComp4',
			9.1: { desc: 'FlashCommanderMode', val: {/*[Mask 0x80]*/  0x0:'Off',  0x80:'On'} },
			9.2: { ref: 'FlashControlMode' },
			17.1: { ref: 'FlashControlMode' },
		...
		FlashInfoUnknown: { 0: 'FlashInfoVersion' },
		MultiExposure: { 
			0: 'MultiExposureVersion',
			1: { desc: 'MultiExposureMode', val: {0:'Off',  1:'Multiple Exposure',  2:'Image Overlay',  3:'HDR'} },
			2: 'MultiExposureShots',
			3: { desc: 'MultiExposureAutoGain', val: {0:'Off',  1:'On'} }
		},
		AFInfo2: { 
			0: 'AFInfo2Version',
			4: { desc: 'ContrastDetectAF', val: {/*(this is Off for the hybrid AF used in Nikon 1 models)*/  0:'Off',  1:'On'} },
			5: 'AFAreaMode', /* TODO - if ContrastDetectAF on or off */
			6: { desc: 'PhaseDetectAF', val: {0:'Off',  1:'On (51-point)',  2:'On (11-point)',  3:'On (39-point)',  4:'On (hybrid)'} },
			7: 'PrimaryAFPoint', /* TODO !!! - same models have different value meanings */
			8: { desc: 'AFPointsUsed', val: ['Center', 'Top', 'Bottom', 'Mid-left', 'Upper-left', 'Lower-left', 'Far Left', 'Mid-right', 'Upper-right', 'Lower-right', 'Far Right'/* TODO ? 	0x7ff = All 11 Points (default) */] },
			...
			24: 'AFAreaWidth',
			26: 'AFAreaHeight',
			28: { desc: 'ContrastDetectAFInFocus', val: {0:'No',  1:'Yes'} },
		},
		FileInfo: { 
			0: 'FileInfoVersion',
			6: 'DirectoryNumber',
		...
		AFTune: { 
			0: { desc: 'AFFineTune', val: {0:'Off',  1:'On (1)',  2:'On (2)'} },
			1: 'AFFineTuneIndex',
			2: 'AFFineTuneAdj' 
		},
		CaptureOffsets: { 
			0x0001: 'IFD0_Offset',
			0x0002: 'PreviewIFD_Offset',
			0x0003: 'SubIFD_Offset' 
		},
		Scan: { 
			0x0002: 'FilmType',
			0x0040: 'MultiSample',
			...
			0x0050: 'MasterGain',
			0x0051: 'ColorGain',
			0x0060: { desc: 'ScanImageEnhancer', val: {0:'Off',  1:'On'} },
			0x0100: 'DigitalICE',
			0x0110: { ref: 'ROC' },
			0x0120: { ref: 'GEM' },
		...
		*/
		NCTG: 
		  ...
		  { 0x0001: 'Make',
			...
			0x1108822: { desc: 'ExposureProgram', val:{	0: 'Not Defined', 1: 'Manual', 2: 'Program AE', 3: 'Aperture-priority AE', 4: 'Shutter speed priority AE', 5: 'Creative (Slow speed)', 6: 'Action (High speed)', 7: 'Portrait', 8: 'Landscape'} },
			0x1109204: 'ExposureCompensation',
			0x1109207: { desc: 'MeteringMode', val:{	0: 'Unknown', 1: 'Average', 2: 'Center-weighted average', 3: 'Spot', 4: 'Multi-spot', 5: 'Multi-segment', 6: 'Partial', 255: 'Other' } },
			0x110a434: 'LensModel',
			0x1200000: 'GPSVersionID',
			0x1200001: { desc: 'GPSLatitudeRef', val: {'N':'North', 'S':'South'} },
			0x1200002: 'GPSLatitude',
			0x1200003: { desc: 'GPSLongitudeRef', val: {'E':'East',  'W':'West'} },
			0x1200004: 'GPSLongitude',
			0x1200005: { desc: 'GPSAltitudeRef', val: {0:'Above Sea Level',  1:'Below Sea Level'} },
			0x1200006: 'GPSAltitude',
			0x1200007: 'GPSTimeStamp',
			0x1200008: 'GPSSatellites',
			0x1200010: { desc: 'GPSImgDirectionRef', val: {'M':'Magnetic North',  'T':'True North'} },
			...
			0x2000083: { desc: 'LensType', val: ['MF', 'D', 'G', 'VR'] },
			0x2000084: 'Lens',
		...
		MOV: { 
			...
			68: { desc: 'WhiteBalance', val: { 0: 'Auto', 1: 'Daylight', 2: 'Shade', 3: 'Fluorescent', 4: 'Tungsten', 5: 'Manual' } },
			72: 'FocalLength',
			175: 'Software',
			223: 'ISO',
		},
		...
		'AVITags':  { 
			...
			0x0010: 'XResolution',
			0x0011: 'YResolution',
			0x0012: { desc: 'ResolutionUnit', val: {1:'None',  2:'inches',  3:'cm'} },
	...
	var camInfos = {
		D40: {
			...
			586.1: { desc: 'VibrationReduction', val: { /*[Mask 0x08]*/ 0x0:'Off',  0x8:'On'} } 
		},
		D80: {
			0: 'ShotInfoVersion',
			586: 'ShutterCount',
			708: { desc: 'NikonImageSize', val: { /*[Mask 0xf0]*/  0x0:'Large (10.0 M)',  0x10:'Medium (5.6 M)',  0x20:'Small (2.5 M)'} },
			748: { ref: /* Custom Settings BIG TODO...*/ 'D80' },
			590.1: { desc: 'Rotation', val: { /*'[Mask 0x07]*/  0x0:'Horizontal',  0x1:'Rotated 270 CW',  0x2:'Rotated 90 CW',  0x3:'Rotated 180'} },
			590.2: { desc: 'VibrationReduction', val: {/*[Mask 0x18]*/ 0x0:'Off',  0x18:'On'} },
			590.3: { desc: 'FlashFired', val: [/*[Mask 0xe0]*/ null, null, null, null, null, null, 'Internal', 'External'] }
		},
		D90: { 
			0: 'ShotInfoVersion',
			4: 'FirmwareVersion',
		...
		D3a: {
			...
			630: 'ShutterCount',
			769: { ref: 'D3' },
			723.1: { desc: 'NikonImageSize', val: {/*[Mask 0x18]'*/  0x0:'Large',  0x8:'Medium',  0x10:'Small'}}
		},
		D3b: {
			0: 'ShotInfoVersion',
			4: 'FirmwareVersion',
			16: 
			 { desc: 'ImageArea', val: {0:'FX (36.0 x 23.9 mm)',  1:'DX (23.5 x 15.6 mm)',  2:'5:4 (30.0 x 23.9 mm)'} },
			605: 'ISO2', 
			637: 'ShutterCount',
			639: 'ShutterCount',
			...
			778: { ref: 'D3' },
			732.1: 
			 { desc: 'NikonImageSize',  val: {/*[Mask 0x18]*/  0x0:'Large',  0x8:'Medium',  0x10:'Small'}}
		},
		D3X: {
			0: 'ShotInfoVersion',
			4: 'FirmwareVersion',
		...
		D3S: {
			0: 'ShotInfoVersion',
			4: 'FirmwareVersion',
			16: { desc: 'ImageArea', val: {0:'FX (36x24)', 1:'DX (24x16)', 2:'5:4 (30x24)', 3:'1.2x (30x20)'} },
			545: 'ISO2',
			578: 'ShutterCount',
			718: { ref: 'D3' }
		},
	...
	var customSettings = { 
		D40: { 
			0.1: { desc: 'Beep', val: {0x0:'On',  0x80:'Off'} },
			0.2: { desc: 'AFAssist', val: {0x0:'On',  0x40:'Off'} },
			0.3: { desc: 'NoMemoryCard', val: {0x0:'Release Locked',  0x20:'Enable Release'} },
			0.4: { desc: 'ImageReview', val: {0x0:'On',  0x10:'Off'} },
			1.1: { desc: 'AutoISO', val: {0x0:'Off',  0x80:'On'} },
			1.2: { desc: 'AutoISOMax', val: {0x10:'400',  0x20:'800',  0x30:'1600'} },
			/*0x0 = 1/125 s\n  0x1 = 1/60 s\n  0x2 = 1/30 s\n  0x3 = 1/15 s': '',*/
			2.1: { desc: 'ImageReviewTime', val: {0x0:'4 s',  0x1:'8 s',  0x2:'20 s',  0x3:'1 min',  0x4:'10 min'} },
			3.1: { desc: 'MonitorOffTime', val: {0x0:'4 s',  0x20:'8 s',  0x40:'20 s',  0x60:'1 min',  0x80:'10 min'} },
			3.2: { desc: 'MeteringTime', val: {0x0:'4 s',  0x4:'8 s',  0x8:'20 s',  0xc:'1 min',  0x10:'30 min'} },
			3.3: { desc: 'SelfTimerTime', val: {0x0:'2 s',  0x1:'5 s',  0x2:'10 s',  0x3:'20 s'} },
			3.4: { desc: 'RemoteOnDuration', val: {0x0:'1 min',  0x40:'5 min',  0x80:'10 min',  0xc0:'15 min'} },
			4.1: { desc: 'AELockButton', val: {0x0:'AE/AF Lock',  0x2:'AE Lock Only',  0x4:'AF Lock Only',  0x6:'AE Lock (hold)',  0x8:'AF-ON'} },
			4.2: { desc: 'AELock', val: {0x0:'Off',  0x1:'On'} },
			5.1: { desc: 'ShootingModeSetting', val: {0x0:'Single Frame',  0x10:'Continuous',  0x20:'Self-timer',  0x30:'Delayed Remote',  0x40:'Quick-response Remote'} },
			5.2: { desc: 'TimerFunctionButton', val: {0x0:'Shooting Mode',  0x1:'Image Quality/Size',  0x2:'ISO',  0x3:'White Balance',  0x4:'Self-timer'} },
			6.1: { desc: 'Metering', val: {0x0:'Matrix',  0x1:'Center-weighted',  0x2:'Spot'} },
			8.1: { desc: 'InternalFlash', val: {0x0:'TTL',  0x10:'Manual'} },
			8.2: 'ManualFlashOutput',
			9: 'FlashLevel',
			10.1: { desc: 'FocusModeSetting', val: {0x0:'Manual',  0x40:'AF-S',  0x80:'AF-C',  0xc0:'AF-A'} },
			11.1: { desc: 'AFAreaModeSetting', val: {0x0:'Single Area',  0x10:'Dynamic Area',  0x20:'Closest Subject'} } 
		},
		D80: { 
			0.1: { desc: 'Beep', val: {0x0:'On',  0x80:'Off'} },
			0.2: { desc: 'AFAssist', val: {0x0:'On',  0x40:'Off'} },
			0.3: { desc: 'NoMemoryCard', val: {0x0:'Release Locked',  0x20:'Enable Release'} },
			0.4: { desc: 'ImageReview', val: {0x0:'On',  0x10:'Off'} },
			0.5: { desc: 'Illumination', val: {0x0:'Off',  0x8:'On'} },
			0.6: { desc: 'MainDialExposureComp', val: {0x0:'Off',  0x4:'On'} },
			0.7: { desc: 'EVStepSize', val: {0x0:'1/3 EV',  0x1:'1/2 EV'} },
			1.1: { desc: 'AutoISO', val: {0x0:'Off',  0x40:'On'} },
			1.2: { desc: 'AutoISOMax', val: {0x0:'200',  0x10:'400',  0x20:'800',  0x30:'1600'} },
			/*0x0 = 1/125 s\n  0x1 = 1/100 s\n  0x2 = 1/80 s\n  0x3 = 1/60 s\n  0x4 = 1/40 s\n  0x5 = 1/30 s': '',*/
			2.1: { desc: 'AutoBracketSet', val: {0x0:'AE & Flash',  0x40:'AE Only',  0x80:'Flash Only',  0xc0:'WB Bracketing'} },
			2.2: { desc: 'AutoBracketOrder', val: {0x0:'0,-,+',  0x20:'-,0,+'} },
			/*0x0 = 5 s\n  0x20 = 10 s\n  0x40 = 20 s': '',
			0x0 = 4 s\n  0x4 = 6 s\n  0x8 = 8 s': '',*/
			3.3: { desc: 'SelfTimerTime', val: {0x0:'2 s',  0x1:'5 s',  0x2:'10 s',  0x3:'20 s'} },
			4.2: { desc: 'AELock', val: {0x0:'Off',  0x1:'On'} },
			4.3: { desc: 'RemoteOnDuration', val: {0x0:'1 min',  0x40:'5 min',  0x80:'10 min',  0xc0:'15 min'} },
			5.1: { desc: 'CommandDials', val: {0x0:'Standard (Main Shutter, Sub Aperture)',  0x80:'Reversed (Main Aperture, Sub Shutter)'} },
			/*0x0 = ISO Display\n  0x8 = Framing Grid\n  0x10 = AF-area Mode\n  0x18 = Center AF Area\n  0x20 = FV Lock': '',*/
			6.1: { desc: 'GridDisplay', val: {0x0:'Off',  0x80:'On'} },
			6.2: { desc: 'ViewfinderWarning', val: {0x0:'On',  0x40:'Off'} },
			6.3: { desc: 'CenterWeightedAreaSize', val: {0x0:'6 mm',  0x4:'8 mm',  0x8:'10 mm'} },
			6.4: { desc: 'ExposureDelayMode', val: {0x0:'Off',  0x20:'On'} },
			6.5: { desc: 'MB-D80Batteries', val: {0x0:'LR6 (AA Alkaline)',  0x1:'HR6 (AA Ni-MH)',  0x2:'FR6 (AA Lithium)',  0x3:'ZR6 (AA Ni-Mg)'} },
			7.1: { desc: 'FlashWarning', val: {0x0:'On',  0x80:'Off'} },
			7.2: 'FlashShutterSpeed',
			7.3: { desc: 'AutoFP', val: {0x0:'Off',  0x4:'On'} },
			7.4: { desc: 'ModelingFlash', val: {0x0:'Off',  0x2:'On'} },
			8.1: { desc: 'InternalFlash', val: {0x0:'TTL',  0x40:'Manual',  0x80:'Repeating Flash',  0xc0:'Commander Mode'} },
			8.2: 'ManualFlashOutput',
			9.1: 'RepeatingFlashOutput',
			9.2: 'RepeatingFlashCount',
			10.1: 'RepeatingFlashRate',
			10.2: 'CommanderChannel',
			11.1: { desc: 'CommanderInternalFlash', val: {0x0:'TTL',  0x40:'Manual',  0x80:'Off'} },
			11.2: { desc: 'CommanderGroupAMode', val: {0x0:'TTL',  0x10:'Auto Aperture',  0x20:'Manual',  0x30:'Off'} },
			11.3: { desc: 'CommanderGroupBMode', val: {0x0:'TTL',  0x4:'Auto Aperture',  0x8:'Manual',  0xc:'Off'} },
			...
			15.1: { desc: 'CenterAFArea', val: {0x0:'Normal Zone',  0x80:'Wide Zone'} },
			15.2: { desc: 'FocusAreaSelection', val: {0x0:'No Wrap',  0x4:'Wrap'} },
			15.3: { desc: 'AFAreaIllumination', val: {0x0:'Auto',  0x1:'Off',  0x2:'On'} },
			16.1: { desc: 'AFAreaModeSetting', val: {0x0:'Single Area',  0x40:'Dynamic Area',  0x80:'Auto-area'} } 
		},
		D90: { 
			0.1: { desc: 'LightSwitch', val: {0x0:'LCD Backlight',  0x8:'LCD Backlight and Shooting Information'} },
			2.1: { desc: 'AFAreaModeSetting', val: {0x0:'Single Area',  0x20:'Dynamic Area',  0x40:'Auto-area',  0x60:'3D-tracking (11 points)'} },
			2.2: { desc: 'CenterFocusPoint', val: {0x0:'Normal Zone',  0x10:'Wide Zone'} },
			2.3: { desc: 'AFAssist', val: {0x0:'On',  0x1:'Off'} },
			2.4: { desc: 'AFPointIllumination', val: {0x0:'Auto',  0x2:'On',  0x4:'Off'} },
			2.5: { desc: 'FocusPointWrap', val: {0x0:'No Wrap',  0x8:'Wrap'} },
			3.2: { desc: 'MB-D80BatteryType', val: {0x0:'LR6 (AA alkaline)',  0x1:'HR6 (AA Ni-MH)',  0x2:'FR6 (AA lithium)',  0x3:'ZR6 (AA Ni-Mn)'} },
			4.1: { desc: 'Beep', val: {0x0:'Off',  0x40:'On'} },
			4.2: { desc: 'GridDisplay', val: {0x0:'Off',  0x2:'On'} },
			4.3: { desc: 'ISODisplay', val: {0x0:'Show ISO/Easy ISO',  0x4:'Show ISO Sensitivity',  0xc:'Show Frame Count'} },
			4.4: { desc: 'ViewfinderWarning', val: {0x0:'On',  0x1:'Off'} },
			4.5: { desc: 'NoMemoryCard', val: {0x0:'Release Locked',  0x20:'Enable Release'} },
			5.1: { desc: 'ScreenTips', val: {0x0:'Off',  0x4:'On'} },
			5.2: { desc: 'FileNumberSequence', val: {0x0:'On',  0x8:'Off'} },
			5.3: { desc: 'ShootingInfoDisplay', val: {0x0:'Auto',  0x80:'Manual (dark on light)',  0xc0:'Manual (light on dark)'} },
			5.4: { desc: 'LCDIllumination', val: {0x0:'Off',  0x20:'On'} },
			6.1: { desc: 'EasyExposureComp', val: {0x0:'Off',  0x1:'On'} },
			6.2: { desc: 'ReverseIndicators', val: {0x0:'+ 0 -',  0x80:'- 0 +'} },
			7.1: { desc: 'ExposureControlStepSize', val: {0x0:'1/3 EV',  0x40:'1/2 EV'} },
			8.1: { desc: 'CenterWeightedAreaSize', val: {0x0:'6 mm',  0x20:'8 mm',  0x40:'10 mm'} },
			8.2: 'FineTuneOptMatrixMetering',
			9.1: 'FineTuneOptCenterWeighted',
			9.2: 'FineTuneOptSpotMetering',
			11.1: 'CLModeShootingSpeed',
			11.2: { desc: 'ExposureDelayMode', val: {0x0:'Off',  0x40:'On'} },
			13.1: { desc: 'AutoBracketSet', val: {0x0:'AE & Flash',  0x20:'AE Only',  0x40:'Flash Only',  0x60:'WB Bracketing',  0x80:'Active D-Lighting'} },
			13.2: { desc: 'AutoBracketOrder', val: {0x0:'0,-,+',  0x10:'-,0,+'} },
			16.1: { desc: 'OKButton', val: {0x0:'Not Used',  0x8:'Select Center Focus Point',  0x10:'Highlight Active Focus Point',  0x18:'Not Used'} },
			/* 0x0 = AE/AF Lock\n  0x8 = AE Lock Only\n  0x10 = AF Lock Only': '', */
			18.1: { desc: 'CommandDialsReverseRotation', val: {0x0:'No',  0x80:'Yes'} },
			18.2: { desc: 'ShutterReleaseButtonAE-L', val: {0x0:'Off',  0x2:'On'} },
			/* 0x0 = 4 s\n  0x10 = 6 s\n  0x20 = 8 s\n  0x30 = 16 s\n  0x40 = 30 s': '', */
			19.2: { desc: 'RemoteOnDuration', val: {0x0:'1 min',  0x1:'5 min',  0x2:'10 min',  0x3:'15 min'} },
			20.1: { desc: 'SelfTimerTime', val: {0x0:'2 s',  0x40:'5 s',  0x80:'10 s',  0xc0:'20 s'} },
			...
			0x0 = 1/60 s\n  0x1 = 1/30 s\n  0x2 = 1/15 s\n  0x3 = 1/8 s\n  0x4 = 1/4 s\n  0x5 = 1/2 s': '',
			*/
			24.1: { desc: 'InternalFlash', val: {0x0:'TTL',  0x40:'Manual',  0x80:'Repeating Flash',  0xc0:'Commander Mode'} },
			24.2: 'ManualFlashOutput',
			25.1: 'RepeatingFlashOutput',
			25.2: 'RepeatingFlashCount',
			26.1: 'RepeatingFlashRate',
			31.1: { desc: 'FlashWarning', val: {0x0:'On',  0x80:'Off'} },
			31.2: 'CommanderInternalTTLComp',
			31.3: { desc: 'ModelingFlash', val: {0x0:'On',  0x20:'Off'} },
			31.4: { desc: 'AutoFP', val: {0x0:'Off',  0x40:'On'} },
			32.1: 'CommanderGroupA_TTLComp',
			33.1: 'CommanderGroupB_TTLComp',
			34.1: { desc: 'LiveViewAF', val: {0x0:'Face Priority',  0x40:'Wide Area',  0x80:'Normal Area'} } 
		},
		D3: { /* TODO - D300 is different */
			11: 'MaxContinuousRelease',
			0.1: { desc: 'CustomSettingsBank', val: {0x0:'A',  0x1:'B',  0x2:'C',  0x3:'D'} },
			0.2: { desc: 'CustomSettingsAllDefault', val: {0x0:'Yes',  0x80:'No'} },
			1.1: { desc: 'AF-CPrioritySelection', val: {0x0:'Release',  0x40:'Release + Focus',  0x80:'Focus'} },
			1.2: { desc: 'AF-SPrioritySelection', val: {0x0:'Focus',  0x20:'Release'} },
			1.3: { desc: 'AFPointSelection', val: {0x0:'51 Points',  0x10:'11 Points'} },
			1.4: { desc: 'DynamicAFArea', val: {0x0:'9 Points',  0x4:'21 Points',  0x8:'51 Points',  0xc:'51 Points (3D-tracking)'} },
			1.5: { desc: 'FocusTrackingLockOn', val: {0x0:'Long',  0x1:'Normal',  0x2:'Short',  0x3:'Off'} },
			2.1: { desc: 'AFActivation', val: {0x0:'Shutter/AF-On',  0x80:'AF-On Only'} },
			2.2: { desc: 'FocusPointWrap', val: {0x0:'No Wrap',  0x8:'Wrap'} },
			/* TODO
			2.3: { desc: 'AFPointIllumination', val: {(D3)',  [Mask 0x60]',  0x0:'On in Continuous Shooting and Manual Focusing',  0x20:'On During Manual Focusing',  0x40:'On in Continuous Shooting Modes',  0x60:'Off',  (D300)',  [Mask 0x06]',  0x0:'Auto',  0x2:'Off',  0x4:'On'} },
			*/
			2.4: { desc: 'AFPointBrightness', val: {0x0:'Low',  0x2:'Normal',  0x4:'High',  0x6:'Extra High'} },
			2.5: { desc: 'AFAssist', val: {0x0:'On',  0x1:'Off'} },
			/* 0x0 = 5 (Long)\n  0x1 = 4\n  0x2 = 3 (Normal)': '', */
			4.2: { desc: 'AssignBktButton', val: {0x0:'Auto Bracketing',  0x8:'Multiple Exposure'} },
			4.3: { desc: 'MultiSelectorLiveView', val: {0x0:'Reset',  0x40:'Zoom On/Off',  0x80:'Start Movie Recording',  0xc0:'Not Used'} },
			4.4: { desc: 'InitialZoomLiveView', val: {0x0:'Low Magnification',  0x10:'Medium Magnification',  0x20:'High Magnification'} },
			6.1: { desc: 'ISOStepSize', val: {0x0:'1/3 EV',  0x40:'1/2 EV',  0x80:'1 EV'} },
			6.2: { desc: 'ExposureControlStepSize', val: {0x0:'1/3 EV',  0x10:'1/2 EV',  0x20:'1 EV'} },
			6.3: { desc: 'ExposureCompStepSize', val: {0x0:'1/3 EV',  0x4:'1/2 EV',  0x8:'1 EV'} },
			6.4: { desc: 'EasyExposureCompensation', val: {0x0:'Off',  0x1:'On',  0x2:'On (auto reset)'} },
			/* TODO
			7.1: { desc: 'CenterWeightedAreaSize', val: {(D3)',  [Mask 0xe0]',  0x0:'8 mm',  0x20:'12 mm',  0x40:'15 mm',  0x60:'20 mm',  0x80:'Average',  (D300)',  [Mask 0xe0]',  0x0:'6 mm',  0x20:'8 mm',  0x40:'10 mm',  0x60:'13 mm',  0x80:'Average'} },
			*/
			7.2: 'FineTuneOptCenterWeighted',
			8.1: 'FineTuneOptMatrixMetering',
			8.2: 'FineTuneOptSpotMetering',
			9.1: { desc: 'MultiSelectorShootMode', val: {0x0:'Select Center Focus Point',  0x40:'Highlight Active Focus Point',  0x80:'Not Used'} },
			9.2: { desc: 'MultiSelectorPlaybackMode', val: {0x0:'Thumbnail On/Off',  0x10:'View Histograms',  0x20:'Zoom On/Off',  0x30:'Choose Folder'} },
			/* TODO
			9.3: { desc: 'InitialZoomSetting', val: {(D3)',  [Mask 0x0c]',  0x0:'High Magnification',  0x4:'Medium Magnification',  0x8:'Low Magnification',  (D300)',  [Mask 0x0c]',  0x0:'Low Magnification',  0x4:'Medium Magnification',  0x8:'High Magnification'} },
			*/
			9.4: { desc: 'MultiSelector', val: {0x0:'Do Nothing',  0x1:'Reset Meter-off Delay'} },
			10.1: { desc: 'ExposureDelayMode', val: {0x0:'Off',  0x40:'On'} },
			10.2: 'CLModeShootingSpeed',
			10.3: { desc: 'CHModeShootingSpeed', val: {0x0:'9 fps',  0x10:'10 fps',  0x20:'11 fps'} },
			12.1: { desc: 'ReverseIndicators', val: {0x0:'+ 0 -',  0x20:'- 0 +'} },
			/* TODO
			12.2: { desc: 'FileNumberSequence', val: {(D3)',  [Mask 0x02]',  0x0:'On',  0x2:'Off',  (D300)',  [Mask 0x08]',  0x0:'On',  0x8:'Off'} },
			*/
			12.3: { desc: 'RearDisplay', val: {0x0:'ISO',  0x80:'Exposures Remaining'} },
			12.4: { desc: 'ViewfinderDisplay', val: {0x0:'Frame Count',  0x40:'Exposures Remaining'} },
			12.5: { desc: 'BatteryOrder', val: {0x0:'MB-D10 First',  0x4:'Camera Battery First'} },
			12.6: { desc: 'MB-D10Batteries', val: {0x0:'LR6 (AA alkaline)',  0x1:'HR6 (AA Ni-MH)',  0x2:'FR6 (AA lithium)',  0x3:'ZR6 (AA Ni-Mn)'} },
			12.7: { desc: 'ScreenTips', val: {0x0:'On',  0x10:'Off'} },
			13.1: { desc: 'Beep', val: {0x0:'High',  0x40:'Low',  0x80:'Off'} },
			13.2: { desc: 'ShootingInfoDisplay', val: {0x0:'Auto',  0x10:'Auto',  0x20:'Manual (dark on light)',  0x30:'Manual (light on dark)'} },
			13.3: { desc: 'GridDisplay', val: {0x0:'Off',  0x2:'On'} },
			13.4: { desc: 'ViewfinderWarning', val: {0x0:'On',  0x1:'Off'} },
			13.5: { desc: 'MultiSelectorPlaybackMode', val: {0x0:'Thumbnail On/Off',  0x1:'View Histograms',  0x2:'Zoom On/Off'} },
			17.1: { desc: 'CommandDialsReverseRotation', val: {0x0:'No',  0x80:'Yes'} },
			17.2: { desc: 'CommandDialsChangeMainSub', val: {0x0:'Off',  0x40:'On'} },
			17.3: { desc: 'CommandDialsApertureSetting', val: {0x0:'Sub-command Dial',  0x20:'Aperture Ring'} },
			17.4: { desc: 'CommandDialsMenuAndPlayback', val: {0x0:'Off',  0x10:'On'} },
			17.5: { desc: 'LCDIllumination', val: {0x0:'Off',  0x8:'On'} },
			17.6: { desc: 'PhotoInfoPlayback', val: {0x0:'Info Up-down, Playback Left-right',  0x4:'Info Left-right, Playback Up-down'} },
			17.7: { desc: 'ShutterReleaseButtonAE-L', val: {0x0:'Off',  0x2:'On'} },
			17.8: { desc: 'ReleaseButtonToUseDial', val: {0x0:'No',  0x1:'Yes'} },
			18.1: { desc: 'SelfTimerTime', val: {0x0:'2 s',  0x8:'5 s',  0x10:'10 s',  0x18:'20 s'} },
			18.2: { desc: 'MonitorOffTime', val: {0x0:'10 s',  0x1:'20 s',  0x2:'1 min',  0x3:'5 min',  0x4:'10 min'} },
			/*
			0x0 = 1/250 s (auto FP)\n  0x20 = 1/250 s\n  0x40 = 1/200 s\n  0x60 = 1/160 s': '',
			0x0 = 1/60 s\n  0x1 = 1/30 s\n  0x2 = 1/15 s\n  0x3 = 1/8 s\n  0x4 = 1/4 s\n  0x5 = 1/2 s': '',
			*/
			21.1: { desc: 'AutoBracketSet', val: {0x0:'AE & Flash',  0x40:'AE Only',  0x80:'Flash Only',  0xc0:'WB Bracketing'} },
			21.2: { desc: 'AutoBracketModeM', val: {0x0:'Flash/Speed',  0x10:'Flash/Speed/Aperture',  0x20:'Flash/Aperture',  0x30:'Flash Only'} },
			21.3: { desc: 'AutoBracketOrder', val: {0x0:'0,-,+',  0x8:'-,0,+'} },
			21.4: { desc: 'ModelingFlash', val: {0x0:'On',  0x1:'Off'} },
			22.1: { desc: 'NoMemoryCard', val: {0x0:'Release Locked',  0x80:'Enable Release'} },
			/*
			0x0 = 4 s\n  0x1 = 6 s\n  0x2 = 8 s\n  0x3 = 16 s\n  0x4 = 30 s': '',
			*/
			23.1: { desc: 'InternalFlash', val: {0x0:'TTL',  0x40:'Manual',  0x80:'Repeating Flash',  0xc0:'Commander Mode'} } 
		},
		D700: { 
			0.1: { desc: 'CustomSettingsBank', val: {0x0:'A',  0x1:'B',  0x2:'C',  0x3:'D'} },
			0.2: { desc: 'CustomSettingsAllDefault', val: {0x0:'Yes',  0x80:'No'} },
			...
			2.1: { desc: 'AFActivation', val: {0x0:'Shutter/AF-On',  0x80:'AF-On Only'} },
			2.2: { desc: 'FocusPointWrap', val: {0x0:'No Wrap',  0x8:'Wrap'} },
			2.3: { desc: 'AFPointIllumination', val: {0x0:'Auto',  0x2:'Off',  0x4:'On'} },
			2.4: { desc: 'AFAssist', val: {0x0:'On',  0x1:'Off'} },
			/* 0x0 = 3 Normal\n  0x1 = 4\n  0x2 = 5 Long': '', */
			4.1: { desc: 'ISOStepSize', val: {0x0:'1/3 EV',  0x40:'1/2 EV',  0x80:'1 EV'} },
			4.2: { desc: 'ExposureControlStepSize', val: {0x0:'1/3 EV',  0x10:'1/2 EV',  0x20:'1 EV'} },
			4.3: { desc: 'ExposureCompStepSize', val: {0x0:'1/3 EV',  0x4:'1/2 EV',  0x8:'1 EV'} },
			4.4: { desc: 'EasyExposureCompensation', val: {0x0:'Off',  0x1:'On',  0x2:'On (auto reset)'} },
			5.1: { desc: 'CenterWeightedAreaSize', val: {0x0:'8 mm',  0x10:'12 mm',  0x20:'15 mm',  0x30:'20 mm',  0x40:'Average'} },
			6.1: 'FineTuneOptMatrixMetering',
			6.2: 'FineTuneOptSpotMetering',
			7.1: { desc: 'ShutterReleaseButtonAE-L', val: {0x0:'Off',  0x80:'On'} },
			7.2: { desc: 'SelfTimerTime', val: {0x0:'2 s',  0x10:'5 s',  0x20:'10 s',  0x30:'20 s'} },
			/*
			0x0 = 4 s\n  0x1 = 6 s\n  0x2 = 8 s\n  0x3 = 16 s\n  0x4 = 30 s': '',
			0x0 = 4 s\n  0x8 = 10 s\n  0x10 = 20 s': '',
			0x0 = 4 s\n  0x1 = 10 s\n  0x2 = 20 s': '',
			*/
			10.1: { desc: 'Beep', val: {0x0:'High',  0x40:'Low',  0x80:'Off'} },
			10.2: { desc: 'ShootingInfoDisplay', val: {0x0:'Auto',  0x10:'Auto',  0x20:'Manual (dark on light)',  0x30:'Manual (light on dark)'} },
			10.3: { desc: 'LCDIllumination', val: {0x0:'Off',  0x8:'On'} },
			10.4: { desc: 'ExposureDelayMode', val: {0x0:'Off',  0x4:'On'} },
			10.5: { desc: 'GridDisplay', val: {0x0:'Off',  0x2:'On'} },
			11.1: { desc: 'FileNumberSequence', val: {0x0:'On',  0x40:'Off'} },
			11.2: 'CLModeShootingSpeed',
			12: 'MaxContinuousRelease',
			13.1: { desc: 'ScreenTips', val: {0x0:'Off',  0x8:'On'} },
			13.2: { desc: 'BatteryOrder', val: {0x0:'MB-D10 First',  0x4:'Camera Battery First'} },
			13.3: { desc: 'MB-D10BatteryType', val: {0x0:'LR6 (AA alkaline)',  0x1:'HR6 (AA Ni-MH)',  0x2:'FR6 (AA lithium)',  0x3:'ZR6 (AA Ni-Mn)'} },
			/* 0x0 = 1/60 s\n  0x1 = 1/30 s\n  0x2 = 1/15 s\n  0x3 = 1/8 s\n  0x4 = 1/4 s\n  0x5 = 1/2 s': '', */
			16.1: { desc: 'FlashControlBuilt-in', val: {0x0:'TTL',  0x40:'Manual',  0x80:'Repeating Flash',  0xc0:'Commander Mode'} },
			16.2: 'ManualFlashOutput',
			17.1: 'RepeatingFlashOutput',
			17.2: 'RepeatingFlashCount',
			18.1: 'RepeatingFlashRate',
			18.2: { desc: 'CommanderInternalTTLChannel', val: {0x0:'1 ch',  0x1:'2 ch',  0x2:'3 ch',  0x3:'4 ch'} },
			20.1: 'CommanderInternalTTLCompBuiltin',
			21.1: 'CommanderInternalTTLCompGroupA',
			22.1: 'CommanderInternalTTLCompGroupB',
			26.1: { desc: 'AutoBracketSet', val: {0x0:'AE & Flash',  0x40:'AE Only',  0x80:'Flash Only',  0xc0:'WB Bracketing'} },
			26.2: { desc: 'AutoBracketModeM', val: {0x0:'Flash/Speed',  0x10:'Flash/Speed/Aperture',  0x20:'Flash/Aperture',  0x30:'Flash Only'} },
			26.3: { desc: 'AutoBracketOrder', val: {0x0:'0,-,+',  0x8:'-,0,+'} },
			26.4: { desc: 'ModelingFlash', val: {0x0:'On',  0x1:'Off'} },
			27.1: { desc: 'MultiSelectorShootMode', val: {0x0:'Select Center Focus Point',  0x40:'Highlight Active Focus Point',  0x80:'Not Used'} },
			27.2: { desc: 'MultiSelectorPlaybackMode', val: {0x0:'Thumbnail On/Off',  0x10:'View Histograms',  0x20:'Zoom On/Off',  0x30:'Choose Folder'} },
			27.3: { desc: 'InitialZoomSetting', val: {0x0:'Low Magnification',  0x4:'Medium Magnification',  0x8:'High Magnification'} },
			27.4: { desc: 'MultiSelector', val: {0x0:'Do Nothing',  0x1:'Reset Meter-off Delay'} },
			33.1: { desc: 'CommandDialsReverseRotation', val: {0x0:'No',  0x80:'Yes'} },
			33.2: { desc: 'CommandDialsChangeMainSub', val: {0x0:'Off',  0x40:'On'} },
			33.3: { desc: 'CommandDialsApertureSetting', val: {0x0:'Sub-command Dial',  0x20:'Aperture Ring'} },
			33.4: { desc: 'CommandDialsMenuAndPlayback', val: {0x0:'Off',  0x10:'On'} },
			33.5: { desc: 'ReverseIndicators', val: {0x0:'+ 0 -',  0x8:'- 0 +'} },
			33.6: { desc: 'PhotoInfoPlayback', val: {0x0:'Off',  0x4:'On'} },
			33.7: { desc: 'NoMemoryCard', val: {0x0:'Release Locked',  0x2:'Enable Release'} },
			33.8: { desc: 'ReleaseButtonToUseDial', val: {0x0:'No',  0x1:'Yes'} } },
		D800: { 
			12.1: { desc: 'AutoBracketingSet', val: {0x0:'AE & Flash',  0x20:'AE Only',  0x40:'Flash Only',  0x60:'WB Bracketing',  0x80:'Active D-Lighting'} },
			12.2: { desc: 'AutoBracketOrder', val: {0x0:'0,-,+',  0x10:'-,0,+'} },
			12.3: { desc: 'AutoBracketingMode', val: {0x0:'Flash/Speed',  0x4:'Flash/Speed/Aperture',  0x8:'Flash/Aperture',  0xc:'Flash Only'} },
			/* 0x0 = 1/60 s\n  0x1 = 1/30 s\n  0x2 = 1/15 s\n  0x3 = 1/8 s\n  0x4 = 1/4 s\n  0x5 = 1/2 s': '', */
			23.1: { desc: 'FlashControlBuilt-in', val: {0x0:'TTL',  0x40:'Manual',  0x80:'Repeating Flash',  0xc0:'Commander Mode'} },
			23.2: 'ManualFlashOutput',
			24.1: 'RepeatingFlashOutput',
			24.2: 'RepeatingFlashCount',
			25.1: 'RepeatingFlashRate',
			25.2: 'CommanderChannel',
			27.1: { desc: 'CommanderInternalFlash', val: {0x0:'TTL',  0x40:'Manual',  0x80:'Off'} },
			27.2: 'CommanderInternalManualOutput',
			28.1: { desc: 'CommanderGroupAMode', val: {0x0:'TTL',  0x40:'Auto Aperture',  0x80:'Manual',  0xc0:'Off'} },
			28.2: 'CommanderGroupAManualOutput',
			29.1: { desc: 'CommanderGroupBMode', val: {0x0:'TTL',  0x40:'Auto Aperture',  0x80:'Manual',  0xc0:'Off'} },
			29.2: 'CommanderGroupBManualOutput',
			30.1: { desc: 'ModelingFlash', val: {0x0:'On',  0x20:'Off'} },
			30.2: 'CommanderInternalTTLComp',
			31.1: 'CommanderGroupA_TTL-AAComp',
			32.1: 'CommanderGroupB_TTL-AAComp' 
		},
		D5000: { 
			0.1: { desc: 'AFAreaModeSetting', val: {0x0:'Single Area',  0x20:'Dynamic Area',  0x40:'Auto-area',  0x60:'3D-tracking (11 points)'} },
			0.2: { desc: 'AFAssist', val: {0x0:'On',  0x1:'Off'} },
			2.1: { desc: 'Beep', val: {0x0:'Off',  0x40:'Low',  0x80:'High'} },
			2.2: { desc: 'GridDisplay', val: {0x0:'On',  0x2:'Off'} },
			2.3: { desc: 'ISODisplay', val: {0x0:'On',  0x8:'Off'} },
			2.4: { desc: 'NoMemoryCard', val: {0x0:'Release Locked',  0x20:'Enable Release'} },
			3.1: { desc: 'FileNumberSequence', val: {0x0:'On',  0x8:'Off'} },
			4.1: { desc: 'RangeFinder', val: {0x0:'Off',  0x10:'On'} },
			4.2: { desc: 'DateImprint', val: {0x0:'Off',  0x8:'On'} },
			4.3: { desc: 'ReverseIndicators', val: {0x0:'+ 0 -',  0x80:'- 0 +'} },
			5.1: { desc: 'EVStepSize', val: {0x0:'1/3 EV',  0x40:'1/2 EV'} },
			9.1: { desc: 'ExposureDelayMode', val: {0x0:'Off',  0x40:'On'} },
			11.1: { desc: 'AutoBracketSet', val: {0x0:'Exposure',  0x40:'Active D-Lighting',  0x80:'WB Bracketing'} },
			15.1: { desc: 'AELockButton', val: {0x0:'AE/AF Lock',  0x8:'AE Lock Only',  0x10:'AF Lock Only',  0x18:'AE Lock (hold)',  0x20:'AF-ON'} },
			16.1: { desc: 'ShutterReleaseButtonAE-L', val: {0x0:'Off',  0x2:'On'} },
			16.2: { desc: 'CommandDialsReverseRotation', val: {0x0:'No',  0x80:'Yes'} },
			17.1: { desc: 'MeteringTime', val: {0x0:'4 s',  0x10:'8 s',  0x20:'20 s',  0x30:'1 min',  0x40:'30 min'} },
			17.2: { desc: 'RemoteOnDuration', val: {0x0:'1 min',  0x1:'5 min',  0x2:'10 min',  0x3:'15 min'} },
			18.1: { desc: 'SelfTimerTime', val: {0x0:'2 s',  0x40:'5 s',  0x80:'10 s',  0xc0:'20 s'} },
			18.2: 'SelfTimerShotCount',
			19.1: { desc: 'ImageReviewTime', val: {0x0:'4 s',  0x20:'8 s',  0x40:'20 s',  0x60:'1 min',  0x80:'10 min'} },
			20.1: { desc: 'PlaybackMenusTime', val: {0x0:'8 s',  0x20:'12 s',  0x40:'20 s',  0x60:'1 min',  0x80:'10 min'} },
			22.1: { desc: 'InternalFlash', val: {0x0:'TTL',  0x40:'Manual'} },
			22.2: 'ManualFlashOutput',
			32.1: { desc: 'LiveViewAF', val: {0x0:'Face Priority',  0x20:'Wide Area',  0x40:'Normal Area',  0x60:'Subject Tracking'} } },
		D5100: { 0.1: { desc: 'AF-CPrioritySelection', val: {0x0:'Release',  0x80:'Focus'} },
			1.1: { desc: 'AFAssist', val: {0x0:'On',  0x1:'Off'} },
			3.1: { desc: 'Beep', val: {0x0:'Off',  0x40:'Low',  0x80:'High'} },
			3.2: { desc: 'NoMemoryCard', val: {0x0:'Release Locked',  0x20:'Enable Release'} },
			3.3: { desc: 'ISODisplay', val: {0x0:'On',  0x8:'Off'} },
			4.1: { desc: 'FileNumberSequence', val: {0x0:'On',  0x8:'Off'} },
			5.1: { desc: 'RangeFinder', val: {0x0:'Off',  0x10:'On'} },
			5.2: { desc: 'ReverseIndicators', val: {0x0:'+ 0 -',  0x80:'- 0 +'} },
			6.1: { desc: 'EVStepSize', val: {0x0:'1/3 EV',  0x40:'1/2 EV'} },
			10.1: { desc: 'ExposureDelayMode', val: {0x0:'Off',  0x40:'On'} },
			12.1: { desc: 'AutoBracketSet', val: {0x0:'Exposure',  0x40:'WB Bracketing',  0x80:'Active D-Lighting'} },
			16.1: { desc: 'AELockButton', val: {0x0:'AE/AF Lock',  0x8:'AE Lock Only',  0x10:'AF Lock Only',  0x18:'AE Lock (hold)',  0x20:'AF-ON'} },
			17.1: { desc: 'ShutterReleaseButtonAE-L', val: {0x0:'Off',  0x2:'On'} },
			17.2: { desc: 'CommandDialsReverseRotation', val: {0x0:'No',  0x80:'Yes'} },
			18.1: { desc: 'MeteringTime', val: {0x0:'4 s',  0x10:'8 s',  0x20:'20 s',  0x30:'1 min',  0x40:'30 min'} },
			18.2: { desc: 'RemoteOnDuration', val: {0x0:'1 min',  0x1:'5 min',  0x2:'10 min',  0x3:'20 min'} },
			19.1: { desc: 'SelfTimerTime', val: {0x0:'2 s',  0x40:'5 s',  0x80:'10 s',  0xc0:'20 s'} },
			19.2: 'SelfTimerShotCount',
			20.1: { desc: 'ImageReviewTime', val: {0x0:'4 s',  0x20:'8 s',  0x40:'20 s',  0x60:'1 min',  0x80:'10 min'} },
			/* 0x0 = 3 min\n  0x4 = 5 min\n  0x8 = 10 min': '', */
			21.1: { desc: 'PlaybackMenusTime', val: {0x0:'8 s',  0x20:'12 s',  0x40:'20 s',  0x60:'1 min',  0x80:'10 min'} },
			23.1: 'ManualFlashOutput' 
		},
		D5200: { 
			0.1: { desc: 'AF-CPrioritySelection', val: {0x0:'Release',  0x80:'Focus'} },
			0.2: { desc: 'NumberOfFocusPoints', val: {0x0:'39 Points',  0x10:'11 Points'} },
			1.1: { desc: 'AFAssist', val: {0x0:'On',  0x1:'Off'} },
			3.1: { desc: 'Beep', val: {0x0:'Off',  0x40:'Low',  0x80:'High'} },
			3.2: { desc: 'NoMemoryCard', val: {0x0:'Release Locked',  0x20:'Enable Release'} },
			3.3: { desc: 'ISODisplay', val: {0x0:'On',  0x8:'Off'} },
			4.1: { desc: 'FileNumberSequence', val: {0x0:'On',  0x8:'Off'} },
			5.1: { desc: 'RangeFinder', val: {0x0:'Off',  0x4:'On'} },
			5.2: { desc: 'ReverseExposureCompDial', val: {0x0:'No',  0x10:'Yes'} },
			5.3: { desc: 'ReverseShutterSpeedAperture', val: {0x0:'No',  0x8:'Yes'} },
			5.4: { desc: 'ReverseIndicators', val: {0x0:'+ 0 -',  0x80:'- 0 +'} },
			6.1: { desc: 'EVStepSize', val: {0x0:'1/3 EV',  0x40:'1/2 EV'} },
			10.1: { desc: 'ExposureDelayMode', val: {0x0:'Off',  0x40:'On'} },
			12.1: { desc: 'AutoBracketSet', val: {0x0:'Exposure',  0x40:'WB Bracketing',  0x80:'Active D-Lighting'} },
			16.1: { desc: 'AELockButton', val: {0x3:'AE/AF Lock',  0x4:'AE Lock Only',  0x6:'AE Lock (hold)',  0x7:'AF Lock Only',  0x8:'AF-ON'} },
			17.1: { desc: 'ShutterReleaseButtonAE-L', val: {0x0:'Off',  0x2:'On'} },
			18.1: { desc: 'StandbyTimer', val: {0x0:'4 s',  0x20:'8 s',  0x40:'20 s',  0x60:'1 min',  0x80:'30 min'} },
			18.2: { desc: 'RemoteOnDuration', val: {0x0:'1 min',  0x1:'5 min',  0x2:'10 min',  0x3:'15 min'} },
			19.1: { desc: 'SelfTimerTime', val: {0x0:'2 s',  0x40:'5 s',  0x80:'10 s',  0xc0:'20 s'} },
			19.2: 'SelfTimerShotCount',
			20.1: { desc: 'ImageReviewTime', val: {0x20:'4 s',  0x40:'8 s',  0x80:'20 s',  0xa0:'1 min',  0xe0:'10 min'} },
			20.2: { desc: 'LiveViewMonitorOffTime', val: {0x4:'5 min',  0x8:'10 min',  0xc:'15 min',  0x10:'20 min',  0x14:'30 min'} },
			21.1: { desc: 'PlaybackMenusTime', val: {0x20:'8 s',  0x80:'20 s',  0xa0:'1 min',  0xc0:'5 min',  0xe0:'10 min'} },
			23.1: { desc: 'InternalFlash', val: {0x0:'TTL',  0x40:'Manual'} },
			23.2: 'ManualFlashOutput' 
		},
		D7000: { 11: 'MaxContinuousRelease',
			0.1: { desc: 'AF-CPrioritySelection', val: {0x0:'Release',  0x80:'Focus'} },
			0.2: { desc: 'AF-SPrioritySelection', val: {0x0:'Focus',  0x20:'Release'} },
			0.3: { desc: 'NumberOfFocusPoints', val: {0x0:'39 Points',  0x10:'11 Points'} },
			/* 0x0 = Off\n  0x1 = 1 Short\n  0x2 = 2: '', */
			1.2: { desc: 'FocusPointWrap', val: {0x0:'No Wrap',  0x8:'Wrap'} },
			1.3: { desc: 'AFPointIllumination', val: {0x0:'Auto',  0x2:'On',  0x4:'Off'} },
			1.4: { desc: 'AFAssist', val: {0x0:'On',  0x1:'Off'} },
			2.1: { desc: 'BatteryOrder', val: {0x0:'MB-D11 First',  0x40:'Camera Battery First'} },
			2.3: { desc: 'MB-D11BatteryType', val: {0x0:'LR6 (AA alkaline)',  0x1:'Ni-MH (AA Ni-MH)',  0x2:'FR6 (AA lithium)'} },
			3.1: { desc: 'BeepPitch', val: {0x0:'Off',  0x40:'Low',  0x80:'High'} },
			3.2: { desc: 'NoMemoryCard', val: {0x0:'Release Locked',  0x20:'Enable Release'} },
			3.3: { desc: 'ISODisplay', val: {0x0:'Show ISO/Easy ISO',  0x4:'Show ISO Sensitivity',  0xc:'Show Frame Count'} },
			3.4: { desc: 'GridDisplay', val: {0x0:'On',  0x2:'Off'} },
			3.5: { desc: 'ViewfinderWarning', val: {0x0:'On',  0x1:'Off'} },
			4.1: { desc: 'ShootingInfoDisplay', val: {0x0:'Auto',  0x80:'Manual (dark on light)',  0xc0:'Manual (light on dark)'} },
			4.2: { desc: 'LCDIllumination', val: {0x0:'Off',  0x20:'On'} },
			4.3: { desc: 'FileNumberSequence', val: {0x0:'On',  0x8:'Off'} },
			4.4: { desc: 'ScreenTips', val: {0x0:'Off',  0x4:'On'} },
			4.5: { desc: 'BeepVolume', val: {0x0:'Off',  0x1:'1',  0x2:'2',  0x3:'3'} },
			5.1: { desc: 'ReverseIndicators', val: {0x0:'+ 0 -',  0x80:'- 0 +'} },
			5.2: { desc: 'EasyExposureCompensation', val: {0x0:'Off',  0x1:'On',  0x2:'On Auto Reset'} },
			6.1: { desc: 'ExposureControlStep', val: {0x0:'1/3 EV',  0x40:'1/2 EV'} },
			6.2: { desc: 'ISOSensitivityStep', val: {0x0:'1/3 EV',  0x10:'1/2 EV'} },
			7.1: { desc: 'CenterWeightedAreaSize', val: {0x0:'6 mm',  0x20:'8 mm',  0x40:'10 mm',  0x60:'13 mm',  0x80:'Average'} },
			10.1: { desc: 'ExposureDelayMode', val: {0x0:'Off',  0x40:'On'} },
			10.2: 'CLModeShootingSpeed',
			12.1: { desc: 'AutoBracketSet', val: {0x0:'AE & Flash',  0x20:'AE Only',  0x40:'Flash Only',  0x60:'WB Bracketing',  0x80:'Active D-Lighting'} },
			12.2: { desc: 'AutoBracketOrder', val: {0x0:'0,-,+',  0x10:'-,0,+'} },
			15.1: { desc: 'OKButton', val: {0x0:'Off',  0x8:'Select Center Focus Point',  0x10:'Highlight Active Focus Point',  0x18:'Not Used'} },
			/* 0x0 = AE/AF Lock\n  0x8 = AE Lock Only\n  0x10 = AF Lock Only': '', */
			17.1: { desc: 'CommandDialsReverseRotation', val: {0x0:'No',  0x80:'Yes'} },
			17.2: { desc: 'CommandDialsChangeMainSub', val: {0x0:'Off',  0x20:'On',  0x40:'On (A mode only)'} },
			17.3: { desc: 'CommandDialsApertureSetting', val: {0x0:'Sub-command Dial',  0x4:'Aperture Ring'} },
			17.4: { desc: 'CommandDialsMenuAndPlayback', val: {0x0:'On',  0x8:'Off',  0x10:'On (Image Review Exclude)'} },
			17.5: { desc: 'ShutterReleaseButtonAE-L', val: {0x0:'Off',  0x2:'On'} },
			17.6: { desc: 'ReleaseButtonToUseDial', val: {0x0:'No',  0x1:'Yes'} },
			/* 0x0 = 4 s\n  0x10 = 6 s\n  0x20 = 8 s\n  0x30 = 16 s\n  0x40 = 30 s': '', */
			18.2: { desc: 'RemoteOnDuration', val: {0x0:'1 min',  0x1:'5 min',  0x2:'10 min',  0x3:'15 min'} },
			19.1: { desc: 'SelfTimerTime', val: {0x0:'2 s',  0x40:'5 s',  0x80:'10 s',  0xc0:'20 s'} },
			19.2: { desc: 'SelfTimerInterval', val: {0x0:'0.5 s',  0x10:'1 s',  0x20:'2 s',  0x30:'3 s'} },
			...
			*/
			...
			30.1: { desc: 'FlashWarning', val: {0x0:'On',  0x80:'Off'} },
			30.2: { desc: 'ModelingFlash', val: {0x0:'On',  0x20:'Off'} },
			34.1: { desc: 'LiveViewAFAreaMode', val: {0x0:'Face-Priority',  0x20:'NormalArea',  0x40:'WideArea',  0x60:'SubjectTracking'} },
			34.2: { desc: 'LiveViewAFMode', val: {0x0:'AF-C',  0x2:'AF-F'} } 
		} 
	};
	...
	var map = function(m1,m2){
		...
		if(makernoteData[m1] instanceof Array && m2 instanceof Array){
			...
			makernoteData[m1].forEach(function(id,i) { 
				if(m2[i] && i<m2.length){
					if(typeof m2[i] === 'string'){
						...
						o[m2[i].desc] = (_name=='') ? id : { value:id, desc:_name };
						_name = null;
					}
				}
			});
			...
			for(var k in m2){
				if(k<makernoteData[m1].length) {
					if(typeof m2[k] === 'string'){
						...
						var _name = ( id in s ) ? s[id] : '';
						if(id<0 && ( '_' in s )) _name = s['_'];
						o[m2[k].desc] = (_name=='') ? id : { value:id, desc:_name };
						_name = null;
			...
			if(makernoteData[m1] in m2) makernoteData[m1] = { value:makernoteData[m1], desc:m2[makernoteData[m1]] };	
		}
		
	}
	
	
	// Nikon flavored Makernote data starts after ten bytes
	var ifdOffset = makernoteOffset+10;
	...
	for (var i = 0; i < numberOfEntries; i++) {
		// (data, entryOffset, tiffOffset, isBigEndian, tags) 
		/* var iEntryOffset = iTIFFStart + iEntriesPosition + i * 12 + 2; */
		var exifEntry = this.extractExifEntry(data, (tiffOffset+makernoteOffset + 2 + (i * 12)), tiffOffset, makernoteEndianness, tags);
		var n = exifEntry.tagName;
		if(n) console.log( n, exifEntry.value );
		var v = (exifEntry.value instanceof Array && exifEntry.value.length==0) ? null : exifEntry.value;
		if (exifEntry && typeof n === 'string' && v !== null){
			if(typeof v === 'string'){
				makernoteData[n] = (n in references && typeof references[n] === 'function') ? references[n](v) : v.replace(/\0/g,'').trim();
			} else if(Buffer.isBuffer(v)){ 
				var str = v.toString('utf8').trim();
				makernoteData[n] = (n in references && typeof references[n] === 'function') ? references[n](v) : str;
			} else {
				makernoteData[n] = (n in references && typeof references[n] === 'function') ? references[n](v) : v;
			}
		}
	}
	n, v = null;
	...
	*/
	...
	map('PreviewIFD', references.PreviewIFD);
	map('ColorBalanceA', references.ColorBalanceA);
	map('PictureControl', references.PictureControl);
	map('WorldTime', references.WorldTime);
	// TODO map('ISOInfo', references.ISOInfo);
	map('DistortInfo', references.DistortInfo);
	map('UnknownInfo', references.UnknownInfo);
	map('UnknownInfo2', references.UnknownInfo2);
	map('HDRInfo', references.HDRInfo);
	map('LocationInfo', references.LocationInfo);
	map('AFInfo', references.AFInfo);
	map('ShotInfo', references.ShotInfo);
	// TODO map('FlashInfo', references.FlashInfo);
	map('AFInfo2', references.AFInfo2);
	map('FileInfo', references.FileInfo);
	map('AFTune', references.AFTune);
	map('PictureControl', references.PictureControl);
	/* TODO : http://www.sno.phy.queensu.ca/~phil/exiftool/TagNames/NikonCapture.html
	map('NikonCapture', references.NikonCapture);
	*/
	map('CaptureOffsets', references.CaptureOffsets);
	map('Scan', references.Scan);
	/* TODO : http://www.sno.phy.queensu.ca/~phil/exiftool/TagNames/ICC_Profile.html
	map('ICC_Profile', references.ICC_Profile);
	*/
	map('CaptureOutput', references.CaptureOutput);
	map('ColorSpace', references.ColorSpace);
	map('ImageAuthentication', references.ImageAuthentication);
	map('ActiveDLighting', references.ActiveDLighting);
	map('VignetteControl', references.VignetteControl);
	map('LensType', references.LensType);
	map('ShootingMode', references.ShootingMode);
	map('RetouchHistory', references.RetouchHistory);
	map('MultiExposure', references.MultiExposure);
	...
	*/
	//console.log('EXIF DATA NIKON MAKERNOTE', util.inspect(makernoteData, false, null));
